...
class DenseFunction(Function):
    ...
    @staticmethod	        #flag_immin = 0 - без SSE и AVX, 1 - SSE, 2 - AVX
    def forward(ctx, input, weight, bias=None, flag_immin = 1):
	
    	output = linear_cpp.forward(input, weight, bias, flag_immin)
